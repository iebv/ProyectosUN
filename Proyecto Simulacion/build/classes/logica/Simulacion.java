...
public class Simulacion {
    ...
    public static void temp() {
        ...
        if (currentTime < simTime) { //Se ejecutan las rutinas mientras se este dentro del tiempo de simulacion	
            ...
            //System.out.println("tamaño cola antes del evento " + colaEsp.size());
            switch (removed.getName()) {
                ...
                case "entradaCaja":
                    ...
                    if (removed.getName().equals("llegada")) {
                        ...
                        //System.out.println("entrada a los " + nuevo.getEntCola());
                        colaEsp.add(nuevo);
                ...
                case "salidaCaja": //Evento salida del cliente de la caja
                    //System.out.println("salida caja");
                ...
                case "salidaCafeteria": //Evento salida del cliente del sistema
                    //System.out.println("salida cafeteria");
        ...
        //System.out.println("tamaño cola luego del evento " + colaEsp.size());
    }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            currentRun++;
        } while (currentRun <= totalRuns); //La simulación se ejecuta 30 veces (dias)
